...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BLDSHARED': 'x86_64-linux-gnu-gcc -pthread -shared -Wl,-O1 -Wl,-Bsymbolic-functions -Wl,-z,relro -fno-strict-aliasing -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -Wdate-time -D_FORTIFY_SOURCE=2 -g -fstack-protector-strong -Wformat -Werror=format-security  ',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/usr' '--enable-ipv6' '--enable-unicode=ucs4' '--with-dbmliborder=bdb:gdbm' '--with-system-expat' '--with-computed-gotos' '--with-system-ffi' '--with-fpectl' 'CC=x86_64-linux-gnu-gcc' 'CFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2 -g -fstack-protector-strong -Wformat -Werror=format-security ' 'LDFLAGS=-Wl,-z,relro'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python2.7',
 'COREPYTHONPATH': ':plat-x86_64-linux-gnu:lib-tk:lib-old',
 'COVERAGE_INFO': '/build/python2.7-AkpPOP/python2.7-2.7.12/build-shared/coverage.info',
 'COVERAGE_REPORT': '/build/python2.7-AkpPOP/python2.7-2.7.12/build-shared/lcov-report',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'x86_64-linux-gnu-gcc -pthread -shared -Wl,-O1 -Wl,-Bsymbolic-functions -Wl,-z,relro -fno-strict-aliasing -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -Wdate-time -D_FORTIFY_SOURCE=2 -g -fstack-protector-strong -Wformat -Werror=format-security  ',
 'LIBC': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python2.7-AkpPOP/python2.7-2.7.12/build-shared',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python2.7-AkpPOP/python2.7-2.7.12/build-shared ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/build/python2.7-AkpPOP/python2.7-2.7.12/build-shared',
 'abs_srcdir': '/build/python2.7-AkpPOP/python2.7-2.7.12/build-shared/..',
